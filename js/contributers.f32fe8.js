...
wl=new woolite();
wl.init();
wl.addAnimation($('.js58')[0], "1.00s", "0.50s", 1, 100);
wl.addAnimation($('.js59')[0], "1.00s", "1.00s", 1, 100);
wl.addAnimation($('.js60')[0], "1.00s", "3.00s", 1, 100);
wl.addAnimation($('.js61')[0], "1.00s", "3.00s", 1, 100);
wl.addAnimation($('.js62')[0], "1.00s", "5.00s", 1, 100);
wl.start();

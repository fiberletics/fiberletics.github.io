...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.js28');e.setAttribute('src',(dpi>1)?'images/htb1flbmarj1gk0jszfu763rhpxa1-238.png':'images/htb1flbmarj1gk0jszfu763rhpxa1-119.png');
var e=document.querySelector('.js29');e.setAttribute('src',(dpi>1)?'images/microchip-308.png':'images/microchip-154.png');
var e=document.querySelector('.js30');e.setAttribute('src',(dpi>1)?'images/bluetooth-controller2-244.png':'images/bluetooth-controller2-122.png');
var e=document.querySelector('.js31');e.setAttribute('src',(dpi>1)?'images/bsam9-1--774.png':'images/bsam9-1--387.png');};
if(!window.HTMLPictureElement){r();}
(function(){$('a[href^="#"]:not(.allowConsent,.noConsent,.denyConsent,.removeConsent)').each(function(i,e){$(e).click(function(){var t=e.hash.length>1?$('[name="'+e.hash.slice(1)+'"]').offset().top:0;return $("html, body").animate({scrollTop:t},400),!1})})})();
wl=new woolite();
wl.init();
wl.addAnimation($('.js32')[0], "1.00s", "10.00s", 1, 100);
wl.addAnimation($('.js33')[0], "1.00s", "11.00s", 1, 100);
wl.start();

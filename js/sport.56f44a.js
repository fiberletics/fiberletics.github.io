...
wl=new woolite();
wl.init();
wl.addAnimation($('.js34')[0], "1.00s", "3.00s", 1, 100);
wl.addAnimation($('.js35')[0], "1.00s", "5.00s", 1, 100);
wl.addAnimation($('.js36')[0], "1.00s", "2.00s", 1, 100);
wl.addAnimation($('.js37')[0], "1.00s", "4.00s", 1, 100);
wl.addAnimation($('.js38')[0], "1.00s", "6.00s", 1, 100);
wl.addAnimation($('.js39')[0], "1.00s", "10.00s", 1, 100);

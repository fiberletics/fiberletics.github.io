...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.js22');e.setAttribute('src',(dpi>1)?'images/htb1flbmarj1gk0jszfu763rhpxa1-238.png':'images/htb1flbmarj1gk0jszfu763rhpxa1-119.png');
var e=document.querySelector('.js23');e.setAttribute('src',(dpi>1)?'images/microchip-308.png':'images/microchip-154.png');

var e=document.querySelector('.js25');e.setAttribute('src',(dpi>1)?'images/ichiro-headshot-162.png':'images/ichiro-headshot-81.png');
var e=document.querySelector('.js26');e.setAttribute('src',(dpi>1)?'images/bluetooth-controller2-244.png':'images/bluetooth-controller2-122.png');};
if(!window.HTMLPictureElement){r();}
(function(){$('a[href^="#"]:not(.allowConsent,.noConsent,.denyConsent,.removeConsent)').each(function(i,e){$(e).click(function(){var t=e.hash.length>1?$('[name="'+e.hash.slice(1)+'"]').offset().top:0;return $("html, body").animate({scrollTop:t},400),!1})})})();
wl=new woolite();
wl.init();
wl.addAnimation($('.js27')[0], "1.00s", "10.00s", 1, 100);
wl.addAnimation($('.js28')[0], "1.00s", "11.00s", 1, 100);
wl.start();

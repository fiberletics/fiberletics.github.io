...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.js51');e.setAttribute('src',(dpi>1)?'images/ichiro-headshot-162.png':'images/ichiro-headshot-81.png');

var e=document.querySelector('.js55');e.setAttribute('src',(dpi>1)?'images/doug-headsot-170.png':'images/doug-headsot-85.png');};
if(!window.HTMLPictureElement){r();}
(function(){$('a[href^="#"]:not(.allowConsent,.noConsent,.denyConsent,.removeConsent)').each(function(i,e){$(e).click(function(){var t=e.hash.length>1?$('[name="'+e.hash.slice(1)+'"]').offset().top:0;return $("html, body").animate({scrollTop:t},400),!1})})})();
wl=new woolite();
wl.init();
wl.addAnimation($('.js49')[0], "1.00s", "0.50s", 1, 100);
wl.addAnimation($('.js50')[0], "1.00s", "3.00s", 1, 100);
wl.addAnimation($('.js52')[0], "1.00s", "2.00s", 1, 100);
wl.addAnimation($('.js53')[0], "1.00s", "3.00s", 1, 100);
wl.addAnimation($('.js56')[0], "1.00s", "0.50s", 1, 100);
wl.addAnimation($('.js57')[0], "1.00s", "5.00s", 1, 100);
wl.start();

...
wl=new woolite();
wl.init();
wl.addAnimation($('.js65')[0], "1.00s", "0.50s", 1, 100);
wl.addAnimation($('.js66')[0], "1.00s", "1.00s", 1, 100);
wl.addAnimation($('.js67')[0], "1.00s", "3.00s", 1, 100);
wl.addAnimation($('.js68')[0], "1.00s", "3.00s", 1, 100);
wl.addAnimation($('.js69')[0], "1.00s", "5.00s", 1, 100);
wl.start();

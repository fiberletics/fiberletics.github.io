...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.js15');e.setAttribute('src',(dpi>1)?'images/video-480.png':'images/video-240.png');
var e=document.querySelector('.js16');e.setAttribute('src',(dpi>1)?'images/pasted-image-232.png':'images/pasted-image-116.png');};
if(!window.HTMLPictureElement){r();}
(function(){$('a[href^="#"]:not(.allowConsent,.noConsent,.denyConsent,.removeConsent)').each(function(i,e){$(e).click(function(){var t=e.hash.length>1?$('[name="'+e.hash.slice(1)+'"]').offset().top:0;return $("html, body").animate({scrollTop:t},400),!1})})})();
wl=new woolite();
wl.init();
wl.addAnimation($('.js17')[0], "2.00s", "1.00s", 1, 100);
wl.addAnimation($('.js18')[0], "1.00s", "3.00s", 1, 100);
wl.addAnimation($('.js19')[0], "1.00s", "10.00s", 1, 100);
wl.addAnimation($('.js20')[0], "1.00s", "11.00s", 1, 100);
wl.addAnimation($('.js21')[0], "1.00s", "13.00s", 1, 100);
wl.start();

...
wl=new woolite();
wl.init();
wl.addAnimation($('.js43')[0], "1.00s", "0.50s", 1, 100);
wl.addAnimation($('.js44')[0], "1.00s", "1.00s", 1, 100);
wl.addAnimation($('.js45')[0], "1.00s", "3.00s", 1, 100);
wl.addAnimation($('.js46')[0], "1.00s", "3.00s", 1, 100);
wl.addAnimation($('.js47')[0], "1.00s", "5.00s", 1, 100);
wl.start();

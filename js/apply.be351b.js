...
wl=new woolite();
wl.init();
wl.addAnimation($('.js38')[0], "1.00s", "0.50s", 1, 100);
wl.addAnimation($('.js39')[0], "1.00s", "3.00s", 1, 100);
wl.addAnimation($('.js40')[0], "1.00s", "2.00s", 1, 100);
wl.addAnimation($('.js41')[0], "1.00s", "3.00s", 1, 100);
wl.addAnimation($('.js42')[0], "1.00s", "5.00s", 1, 100);
wl.start();

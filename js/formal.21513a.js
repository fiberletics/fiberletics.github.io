...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.js38');e.setAttribute('src',(dpi>1)?'images/pasted-image-232.png':'images/pasted-image-116.png');};
if(!window.HTMLPictureElement){r();}
(function(){$('a[href^="#"]:not(.allowConsent,.noConsent,.denyConsent,.removeConsent)').each(function(i,e){$(e).click(function(){var t=e.hash.length>1?$('[name="'+e.hash.slice(1)+'"]').offset().top:0;return $("html, body").animate({scrollTop:t},400),!1})})})();
wl=new woolite();
wl.init();
wl.addAnimation($('.js39')[0], "1.00s", "10.00s", 1, 100);
wl.addAnimation($('.js40')[0], "1.00s", "11.00s", 1, 100);
wl.start();

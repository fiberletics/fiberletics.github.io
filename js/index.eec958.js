...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.js6');e.setAttribute('src',(dpi>1)?'images/pasted-image-232.png':'images/pasted-image-116.png');};
if(!window.HTMLPictureElement){r();}
(function(){$('a[href^="#"]:not(.allowConsent,.noConsent,.denyConsent,.removeConsent)').each(function(i,e){$(e).click(function(){var t=e.hash.length>1?$('[name="'+e.hash.slice(1)+'"]').offset().top:0;return $("html, body").animate({scrollTop:t},400),!1})})})();
wl=new woolite();
wl.init();
wl.addAnimation($('.js1')[0], "1.00s", "4.00s", 1, 100);
wl.addAnimation($('.js2')[0], "1.00s", "4.60s", 1, 100);
wl.addAnimation($('.js3')[0], "1.00s", "5.00s", 1, 100);
wl.addAnimation($('.js4')[0], "1.00s", "5.60s", 1, 100);
wl.addAnimation($('.js5')[0], "1.00s", "6.60s", 1, 100);
wl.addAnimation($('.js7')[0], "1.00s", "6.00s", 1, 100);
wl.addAnimation($('.js8')[0], "1.00s", "8.00s", 1, 100);
wl.addAnimation($('.js9')[0], "1.00s", "8.00s", 1, 100);
wl.addAnimation($('.js10')[0], "2.00s", "1.00s", 1, 100);
wl.addAnimation($('.js11')[0], "1.00s", "10.00s", 1, 100);
wl.addAnimation($('.js12')[0], "1.00s", "11.00s", 1, 100);
wl.start();

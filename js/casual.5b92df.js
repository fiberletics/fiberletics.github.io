...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.js42');e.setAttribute('src',(dpi>1)?'images/screen-shot-2021-06-08-at-10.42.13-pm-674.jpg':'images/screen-shot-2021-06-08-at-10.42.13-pm-337.jpg');};
if(!window.HTMLPictureElement){r();}
(function(){$('a[href^="#"]:not(.allowConsent,.noConsent,.denyConsent,.removeConsent)').each(function(i,e){$(e).click(function(){var t=e.hash.length>1?$('[name="'+e.hash.slice(1)+'"]').offset().top:0;return $("html, body").animate({scrollTop:t},400),!1})})})();
wl=new woolite();
wl.init();
wl.addAnimation($('.js43')[0], "1.00s", "10.00s", 1, 100);
wl.addAnimation($('.js44')[0], "1.00s", "11.00s", 1, 100);
wl.start();
